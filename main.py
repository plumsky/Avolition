...
class Config(DirectObject):
    def __init__(self):
        ...
        self.res11.bind(DGG.B1PRESS, self.set_option,
                        ["resolution", "800 600"])
        ...
        self.res21.bind(DGG.B1PRESS, self.set_option,
                        ["resolution", "1280 800"])
        ...
        self.res31.bind(DGG.B1PRESS, self.set_option,
                        ["resolution", "1280 720"])
        ...
        self.res12.bind(DGG.B1PRESS, self.set_option,
                        ["resolution", "1024 768"])
        ...
        self.res22.bind(DGG.B1PRESS, self.set_option,
                        ["resolution", "1440 900"])
        ...
        self.res32.bind(DGG.B1PRESS, self.set_option,
                        ["resolution", "1366 768"])
        ...
        self.res13.bind(DGG.B1PRESS, self.set_option,
        ...
        self.res23.bind(DGG.B1PRESS, self.set_option,
        ...
        self.res33.bind(DGG.B1PRESS, self.set_option,
        ...
        self.safeModeButton.bind(
            DGG.B1PRESS, self.set_option, ["safemode", False])
        ...
        self.keymapOrder = ['key_forward', 'key_back', 'key_left', 'key_right', 'key_cam_left',
                            'key_cam_right', 'key_action1', 'key_action2', 'key_zoomin', 'key_zoomout']
    ...
    def save_and_exit(self, event=None):
        ...
        with open(path+"autoconfig.txt", "w") as temp:
            ...
            temp.write("#use config.txt to hand-edit custom options\n")
            temp.write("win-size "+str(self.options["resolution"])+"\n")
            temp.write("music-volume " +
                       str(int(base.musicManager.getVolume()*100.0))+"\n")
            temp.write("sound-volume " +
                       str(int(base.sfxManagerList[0].getVolume()*100.0))+"\n")
            if self.options["bloom"]:
                temp.write("bloom 1\n")
            else:
                temp.write("bloom 0\n")
