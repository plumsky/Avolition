...
class PC1(DirectObject):
    ...
    def onLevelLoad(self, common):
        ...
        if not self.common['safemode']:
            ...
            # shadows
            self.floor.projectTexture(
                self.common['shadow_ts'], self.common['shadowTexture'], self.common['shadowCamera'])
    ...
    def __init__(self, common):
        ...
        self.keyMap = {'key_forward': False,
                       ...
                       'key_action2': False}
        # prime key
        self.accept(common['keymap']['key_forward'][0],
                    self.keyMap.__setitem__, ["key_forward", True])
        self.accept(common['keymap']['key_back'][0],
                    self.keyMap.__setitem__, ["key_back", True])
        self.accept(common['keymap']['key_left'][0],
                    self.keyMap.__setitem__, ["key_left", True])
        self.accept(common['keymap']['key_right'][0],
                    self.keyMap.__setitem__, ["key_right", True])
        self.accept(common['keymap']['key_cam_left'][0],
                    self.keyMap.__setitem__, ["key_cam_left", True])
        self.accept(common['keymap']['key_cam_right'][0],
                    self.keyMap.__setitem__, ["key_cam_right", True])
        self.accept(common['keymap']['key_action1'][0],
                    self.keyMap.__setitem__, ["key_action1", True])
        self.accept(common['keymap']['key_action2'][0],
                    self.keyMap.__setitem__, ["key_action2", True])
        # alt key
        self.accept(common['keymap']['key_forward'][1],
                    self.keyMap.__setitem__, ["key_forward", True])
        self.accept(common['keymap']['key_back'][1],
                    self.keyMap.__setitem__, ["key_back", True])
        self.accept(common['keymap']['key_left'][1],
                    self.keyMap.__setitem__, ["key_left", True])
        self.accept(common['keymap']['key_right'][1],
                    self.keyMap.__setitem__, ["key_right", True])
        self.accept(common['keymap']['key_cam_left'][1],
                    self.keyMap.__setitem__, ["key_cam_left", True])
        self.accept(common['keymap']['key_cam_right'][1],
                    self.keyMap.__setitem__, ["key_cam_right", True])
        self.accept(common['keymap']['key_action1'][1],
                    self.keyMap.__setitem__, ["key_action1", True])
        self.accept(common['keymap']['key_action2'][1],
                    self.keyMap.__setitem__, ["key_action2", True])
        self.accept(common['keymap']['key_forward'][0],
                    self.keyMap.__setitem__, ["key_forward", True])
        # prime key up
        self.accept(common['keymap']['key_forward'][0]+"-up",
                    self.keyMap.__setitem__, ["key_forward", False])
        self.accept(common['keymap']['key_back'][0]+"-up",
                    self.keyMap.__setitem__, ["key_back", False])
        self.accept(common['keymap']['key_left'][0]+"-up",
                    self.keyMap.__setitem__, ["key_left", False])
        self.accept(common['keymap']['key_right'][0]+"-up",
                    self.keyMap.__setitem__, ["key_right", False])
        self.accept(common['keymap']['key_cam_left'][0]+"-up",
                    self.keyMap.__setitem__, ["key_cam_left", False])
        self.accept(common['keymap']['key_cam_right'][0]+"-up",
                    self.keyMap.__setitem__, ["key_cam_right", False])
        self.accept(common['keymap']['key_action1'][0]+"-up",
                    self.keyMap.__setitem__, ["key_action1", False])
        self.accept(common['keymap']['key_action2'][0]+"-up",
                    self.keyMap.__setitem__, ["key_action2", False])
        # alt key up
        self.accept(common['keymap']['key_forward'][1]+"-up",
                    self.keyMap.__setitem__, ["key_forward", False])
        self.accept(common['keymap']['key_back'][1]+"-up",
                    self.keyMap.__setitem__, ["key_back", False])
        self.accept(common['keymap']['key_left'][1]+"-up",
                    self.keyMap.__setitem__, ["key_left", False])
        self.accept(common['keymap']['key_right'][1]+"-up",
                    self.keyMap.__setitem__, ["key_right", False])
        self.accept(common['keymap']['key_cam_left'][1]+"-up",
                    self.keyMap.__setitem__, ["key_cam_left", False])
        self.accept(common['keymap']['key_cam_right'][1]+"-up",
                    self.keyMap.__setitem__, ["key_cam_right", False])
        self.accept(common['keymap']['key_action1'][1]+"-up",
                    self.keyMap.__setitem__, ["key_action1", False])
        self.accept(common['keymap']['key_action2'][1]+"-up",
                    self.keyMap.__setitem__, ["key_action2", False])
        self.accept(common['keymap']['key_forward'][0]+"-up",
                    self.keyMap.__setitem__, ["key_forward", False])

        # camera zoom
        self.accept(common['keymap']['key_zoomin']
                    [0], self.zoom_control, [0.1])
        self.accept(common['keymap']['key_zoomout']
                    [0], self.zoom_control, [-0.1])
        self.accept(common['keymap']['key_zoomin']
                    [1], self.zoom_control, [0.1])
        self.accept(common['keymap']['key_zoomout']
                    [1], self.zoom_control, [-0.1])
        ...
        self.cursorPower.stateNodePath[0].setTexScale(
            TextureStage.getDefault(), 0.25, 0.25)
        self.cursorPower.stateNodePath[0].setTexOffset(
            TextureStage.getDefault(), self.cursorPowerUV[0], self.cursorPowerUV[1])
        ...
        self.cursorPower2.stateNodePath[0].setTexScale(
            TextureStage.getDefault(), 0.25, 0.25)
        self.cursorPower2.stateNodePath[0].setTexOffset(
            TextureStage.getDefault(), self.cursorPowerUV2[0], self.cursorPowerUV2[1])
        ...
        self.common['traverser'].addCollider(
            self.coll_ray, self.common['queue'])

        # collision sphere
        mask_2_3 = BitMask32.bit(3)
        mask_2_3.setBit(2)
        self.coll_sphere = self.node.attachNewNode(
            CollisionNode('playerSphere'))
        ...
        self.common['traverser'].addCollider(
            self.coll_sphere, self.common['queue'])
        # coll_sphere.show()
        ...
        self.common['traverser'].addCollider(
            self.attack_ray, self.common['queue'])
    ...
    def optionsSet(self, opt, event=None):
        ...
        if opt == "close":
            ...
            if self.isOptionsOpen:
                Sequence(LerpPosInterval(self.options, 0.1, VBase3(winX, 0, -128+84)),
                         LerpPosInterval(self.options, 0.2, VBase3(210+winX, 0, -128+84))).start()
                # self.options.setPos(210+winX,0,-128+84)
                ...
                Sequence(LerpPosInterval(self.options, 0.2, VBase3(winX, 0, -128+84)),
                         LerpPosInterval(self.options, 0.1, VBase3(winX, 0, -128))).start()
            ...
            base.sfxManagerList[0].setVolume(
                self.options_slider1['value']*0.01)
        elif opt == "music":
    ...
    def heal(self):
        ...
        vfx(self.node, texture='vfx/vfx3.png', scale=.8, Z=1.0,
            depthTest=False, depthWrite=False).start(0.03)
        self.healthBar.setScale(10, 1, 1)
    ...
    def hit(self, damage):
        ...
        if self.isBlockin:
            ...
            vfx(self.node, texture='vfx/blood_red.png', scale=.3,
                Z=1.0, depthTest=True, depthWrite=True).start(0.016)
                ...
                if monster:
                    ...
                    if monster:
                        ...
                        if self.crit_hit > random.random():
                            Sequence(Wait(0.2), Func(
                                monster.onHit, self.crit_dmg)).start()
        self.hitMonsters = set()
    ...
    def zoom_control(self, amount):
        LerpFunc(self.zoom, fromData=0, toData=amount,
                 duration=.5, blendType='easeOut').start()
    ...
    def update(self, task):
        ...
        if self.keyMap["key_cam_right"]:
            self.cameraNode.setH(self.cameraNode, -70 *
                                 dt * self.camera_momentum)
            self.camera_momentum += dt*3
        ...
        for entry in self.common['queue'].getEntries():
            if entry.getFromNodePath().hasTag("player"):
                ...
                if entry.getIntoNodePath().hasTag("id"):
                    self.monster_list[int(
                        entry.getIntoNodePath().getTag("id"))].PCisInRange = True
                    hit_wall = False
            ...
            if self.plane.intersectsLine(pos3d, render.getRelativePoint(camera, nearPoint), render.getRelativePoint(camera, farPoint)):
                ...
                if not self.common['safemode']:
                    if self.node.getDistance(self.pLightNode) < 13.0:
                        self.common['shadowNode'].setPos(
                            self.pLightNode.getPos(render))
                        self.common['shadowNode'].setZ(2.7)
            pos2d = Point3(base.mouseWatcherNode.getMouseX(),
                           0, base.mouseWatcherNode.getMouseY())
...
class PC2(DirectObject):
    ...
    def __init__(self, common):
        ...
        self.sounds['plasma_fly'] = self.audio3d.loadSfx(
            "sfx/plasma_fly_loop.ogg")
        ...
        self.plasma_vfx = vfx(self.plasma_node, texture='vfx/plasm2.png',
                              scale=0.05, Z=0, depthTest=True, depthWrite=True)
        # self.plasma_vfx.loop(0.015)
        self.plasma_vfx.hide()
        self.plasmaLock = False
        self.isBoom = False
        self.projectile = vfx(self.plasma_node, texture='vfx/plasm2.png',
                              scale=0.05, Z=0, depthTest=True, depthWrite=True)
        if 'plasma_coll' in self.common:
            self.plasma_coll = self.common['plasma_coll']
        else:
            self.plasma_coll = render.attachNewNode(
                CollisionNode('plasmaSphere'))
            ...
            self.audio3d.attachSoundToObject(
                self.sounds['plasma_fly'], self.plasma_coll)
            self.audio3d.attachSoundToObject(
                self.sounds['plasma_hit'], self.plasma_coll)

        self.common['traverser'].addCollider(
            self.plasma_coll, self.common['queue'])
        self.lastPower = 0
        self.hitSelf = False
    ...
    def plasma_dmg(self, power):
        # print power
        final = (power+5)*self.power_progress+((power+5) *
                                               (power+5)/15.0) * (1.0-self.power_progress)
    ...
    def boom(self):
        ...
        if vfx_node:
            vfx_node.hide()
            vfx(None, texture='vfx/m_blast.png', scale=scale, Z=0.0, depthTest=True,
                depthWrite=True, pos=vfx_node.getPos(render)).start(0.016)
    ...
    def plasma_task(self, task):
        ...
        if self.keyMap["key_action1"] and not self.plasmaLock:
            ...
            if self.powerUp == 0:
                if self.autoCamera and not self.pauseCamera and not self.isOptionsOpen:
                    if abs(self.cameraNode.getH()-self.node.getH()) > 90.0:
                        ...
                        Sequence(LerpHprInterval(self.cameraNode, 0.2, self.node.getHpr()), Func(
                            self.resetPointer, reset_pos)).start()
            ...
            if self.powerUp > 0:
                ...
                self.projectile = MovingVfx(self.plasma_node, self.target_node, texture='vfx/plasm2.png',
                                            scale=0.05, Z=0.0, time=.6, gravity=.55, depthTest=True, depthWrite=True)
                ...
                Sequence(Wait(0.1), Func(self.arm_plasma),
                         Wait(0.4), Func(self.boom)).start()
    ...
    def lightning_task(self, task):
        ...
        if self.keyMap["key_action2"]:
            ...
            self.lightning_vfx.setTexOffset(
                TextureStage.getDefault(), self.vfxU, self.vfxV)
        ...
        for entry in self.common['queue'].getEntries():
            ...
            if entry.getFromNodePath().hasTag("plasma"):
                if entry.getIntoNodePath().hasTag("radar"):
                    ...
                    if self.isBoom:
                        if entry.getIntoNodePath().hasTag("id"):
                            self.hitMonsters.add(
                                entry.getIntoNodePath().getTag("id"))
...
class PC3(DirectObject):
    ...
    def __init__(self, common):
        ...
        self.arrow_bone = self.actor.exposeJoint(
            None, 'modelRoot', 'arrow_bone')
        ...
        for i in range(8):
            self.arrowSpheres.append(
                render.attachNewNode(CollisionNode('arrow'+str(i))))
            ...
            self.common['traverser'].addCollider(
                self.arrowSpheres[-1], self.common['queue'])
    ...
    def update(self, task):
        ...
        for entry in self.common['queue'].getEntries():
            if entry.getFromNodePath().hasTag('arrow'):
                ...
                if entry.getIntoNodePath().hasTag("id"):
                    self.attack(arrow, self.monster_list[int(
                        entry.getIntoNodePath().getTag("id"))])
                    self.stickArrow(arrow, self.monster_list[int(
                        entry.getIntoNodePath().getTag("id"))])
...
class PC4(DirectObject):
    ...
    def __init__(self, common):
        ...
        self.aura = vfx(self.actor, texture='vfx/aura2.png',
                        scale=.75, Z=.85, depthTest=False, depthWrite=False)
        self.aura.loop(0.02)
        ...
        self.coll_ray2 = self.magma_node.attachNewNode(
            CollisionNode('collRay'))
        ...
        #self.traverser.addCollider(self.coll_ray, self.queue)
        self.common['traverser'].addCollider(
            self.coll_ray2, self.common['queue'])
        ...
        taskMgr.add(self.__getMousePos, "mousePosTask")
        taskMgr.add(self.update, "updatePC")
        taskMgr.doMethodLater(0.05+self.teleportTime,
                              self.teleport_task, 'teleport_task')
        ...
        if self.hitMonsters:
            for monster in self.hitMonsters:
                ...
                if monster and self.monster_list:
                    monster = self.monster_list[int(monster)]
                    if monster:
                        Sequence(Wait(random.uniform(0.0, 0.2)),
                                 Func(monster.onMagmaHit)).start()
        if self.playerHit:
            if self.HP <= 0:
                return task.done
            # print "hit player"
            self.sounds['flame'].play()
            vfx(self.node, texture="vfx/small_flame.png", scale=.6, Z=.7,
                depthTest=False, depthWrite=False).start(0.016, stopAtFrame=24)
            self.HP -= 2.0
            # print self.HP
            if self.HP <= 0:
                if(self.actor.getCurrentAnim() != "die"):
    ...
    def magmaMover(self, task):
        if self.magmaList[-1].getCurrentAnim() == "flow":
            return task.done
        LerpPosInterval(self.magmaList[-1], 0.6,
                        self.magma_node.getPos()).start()
        LerpHprInterval(
            self.magmaList[-1], 0.2, self.magmaList[-1].getHpr()+Point3(10, 0, 0)).start()
        return task.again
    ...
    def magmaDrop(self):
        ...
        LerpScaleInterval(collider, speed, scale*3.0,
    ...
    def doTeleport(self):
        ...
        if self.canTeleport:
            ...
            vfx(self.actor, texture='vfx/tele2.png', scale=.5,
                Z=.85, depthTest=False, depthWrite=False).start()
        ...
        for entry in self.common['queue'].getEntries():
            ...
            if entry.getFromNodePath().hasTag("magma"):
                ...
                if into.hasTag('id'):
                    ...
                    self.monster_list[int(into.getTag("id"))].lastMagmaDmg = entry.getFromNodePath(
                    ).getPythonTag("power")
